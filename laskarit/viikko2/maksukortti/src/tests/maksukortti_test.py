...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_edullinen_lounas_onnistuu_kun_rahaa_vain_edullisen_lounaan_verran(self):
        kortti = Maksukortti(250)
        kortti.syo_edullisesti()
        
        self.assertEqual(str(kortti), "Kortilla on rahaa 0.00 euroa")
        
    def test_maukas_lounas_onnistuu_kun_rahaa_vain_maukkaan_lounaan_verran(self):
